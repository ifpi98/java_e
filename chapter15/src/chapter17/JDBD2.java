...
//        query = "UPDATE student SET `id` = '0189011' WHERE `id` = '0893012';";
//        query = "UPDATE student SET `id` = '0893012' WHERE `id` = '0189011';";
        
        query = "DELETE FROM student WHERE `NAME` = '아무개';";
...
//            System.out.println("-------------------------");
        	...
        	System.out.print("\t|\t" + new String(rs.getString("dept")));
        	System.out.println();
